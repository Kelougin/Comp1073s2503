...
output.textContent = `The first element of array inside myArray is ${myArray[3][0]}`;
...
console.log(`The last array element is ${orig6Array[orig6Array.length - 1]}`);
...
let orig6Length = orig6Array.push("Philidelphia Flyers");
